...
echo "Please run the following command to configure your CLI Mini AI:"
echo "$CONFIG_SCRIPT"
echo "After configuration, please restart your terminal or source your shell configuration file."
